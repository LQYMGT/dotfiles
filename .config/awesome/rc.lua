...
mytextclock = awful.widget.textclock(markup("#7788af", " %b %d %A ") .. markup("#de5e1e", " %H:%M "))
...
--        end),
    ...
    awful.key({ modkey            }, "d",
	    ...
	    local f  = io.popen("ydcv '"..new_word.."'")
            ...
            f:close()
            _dict_notify = naughty.notify({ text = fc, timeout = 3, width = 320 })
    end),
...
--    awful.key({ altkey }, "h",      function () awful.tag.incmwfact(-0.05)     end),
    ...
    -- Dropdown terminal
    awful.key({ modkey,	          }, "z",      function () drop(terminal, 'top', 'right', 0.45, 0.44) end),
...
--    awful.key({ altkey,           }, "h",      function () fswidget.show(7) end),
    ...
    awful.key({ modkey }, "0", function ()  mouse.coords({x = 1366, y = 768}) end),
